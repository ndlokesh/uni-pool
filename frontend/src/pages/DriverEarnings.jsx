...
const DriverEarnings = () => {
    ...
    const { totalEarnings, dailyStats, weeklyStats, monthlyStats } = stats || {};
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] pb-20">
            ...
            <div className="container mx-auto px-6 py-10 max-w-4xl animate-fade-in-up">
                ...
                <h1 className="text-4xl font-bold text-white mb-2">My Earnings</h1>
                <p className="text-gray-400 mb-10">Track your revenue and financial performance.</p>

                {/* Total Earnings Summary Card */}
                <div className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-3xl p-8 shadow-2xl border border-white/10 relative overflow-hidden group mb-12">
